...
case "${DEVICE}" in
  ...
  RK3566*)
    ...
    PKG_EMUS+=" box64 dolphin-sa drastic-sa mednafen melonds-sa portmaster scummvmsa yabasanshiro-sa advancemame-sa openmsx-sa advanced_drastic-sa"
  ...
  RK3326)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="box86 desmume-lr gpsp-lr pcsx_rearmed-lr"
    PKG_DEPENDS_TARGET+=" common-shaders glsl-shaders"
    PKG_EMUS+=" box64 drastic-sa mednafen portmaster scummvmsa yabasanshiro-sa advanced_drastic-sa"
...
makeinstall_target() {
  ...
  case ${DEVICE} in
    RK3399|AMD64|RK3326|RK3588*|RK356*|H700|SD865)
  ...
  case ${DEVICE} in
    ...
    ;;
    RK3399|RK3*)
      add_emu_core nds advanced_drastic advanced_drastic-sa true
  ...
  case ${DEVICE} in
    AMD64|S922X|RK3399|RK3588|SD865)
  ...
  case ${DEVICE} in
    AMD64|S922X|RK3399|RK358*|SD865)
